...
export const metadata = buildMetadata({
  title: 'جستجوی متوفی بهشت زهرا؛ قطعه، ردیف و شماره قبر',
  description:
    'راهنمای کامل جستجوی متوفی در بهشت زهرا: ورود به سامانه رسمی، پیدا کردن قطعه و ردیف و شماره قبر، معنی ردیف مکرر و راه‌حل وقتی نتیجه‌ای پیدا نمی‌شود.',
  ...
  return (
    <div className="container pb-16">
      ...
      <header className="mb-8 max-w-3xl">
        <h1 className="mb-4">جستجوی متوفی در بهشت زهرا</h1>
        <div className="prose-fa">
          <p>
            برای پیدا کردن محل دفن یکی از عزیزان در بهشت زهرا (س) به سه عدد نیاز دارید: شماره
            <strong> قطعه</strong>، <strong>ردیف</strong> و <strong>شماره قبر</strong>. این اطلاعات
            در سامانه رسمی شهرداری تهران موجود است و جستجو در آن کاملاً رایگان است.
          </p>
          <p>
            در این صفحه توضیح داده‌ایم که چطور جستجو کنید، نتیجه را چطور بخوانید و اگر چیزی پیدا
            نشد چه کار کنید.
          </p>
        </div>
      </header>
